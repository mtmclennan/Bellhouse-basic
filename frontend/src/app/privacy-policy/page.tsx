    ...
    <main className={classes.page}>
      <div className={classes.container}>
        ...
        <section className={classes.section}>
          ...
          <ul>
            <li>
              Messages may include project updates, scheduling information, and
        ...
        <section className={classes.section}>
          ...
          <p>
            ...
            request. We use third-party email service providers to deliver these
            communications.
          </p>
        </section>
        ...
        <section className={classes.section}>
          ...
          <p>
            ...
            your information. Data may be stored using secure hosting providers,
            email service providers, phone/SMS providers, and internal tracking
            systems.
          </p>
          <p>
        ...
        <section className={classes.section}>
          ...
          <p>
            ...
            share information only when necessary to provide requested services
        ...
        <section className={classes.section}>
          <h2>9. Your Rights</h2>
          <p>
            Under Canadian privacy law, you may request access to your personal
            information, request corrections, withdraw SMS consent, or request
