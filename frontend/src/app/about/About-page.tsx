        ...
        <div className="about-content__intro">
          <div>
            ...
            <p>
              ...
              Halton, and surrounding areas. Built on a foundation of expertise,
              reliability, and customer satisfaction, we take pride in
              delivering high-quality workmanship and dependable service on
              every project.
            </p>
          </div>
          <Image
        ...
        <div className="about-content__intro">
          <div className="about-content__future">
            ...
            <p>
              ...
              facets of excavation, took over the management of the company. His
              deep industry knowledge, hands-on approach, and commitment to
              innovation have allowed Bellhouse Excavating to continue its
